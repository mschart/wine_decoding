...
def dim_red(algo, chem_type,ax=None, fig=None,
    ...
    d = np.load(f'/home/mic/wine/data/{chem_type}.npy', 
...
def dim_red_grape_ratio(algo,ax=None,rs=8):
    ...
    d = np.load('/home/mic/wine/data/varietals.npy', 
                allow_pickle=True).flat[0]
...
def plot_tile_main(rs=28):
    ...
    img = mpimg.imread('/home/mic/wine/figs/bordeaux_map.png')
    plt.imshow(img)
    plt.axis('off')
    add_panel_letter(1)
    ...
    plt.tight_layout()
    #plt.savefig(f'/home/mic/wine/figs/dim_reduction/png2/{rs}.png')
    #plt.close()
    plt.show()    
...
def plot_tile_chem32():
    ...
    fig.tight_layout()
    fig.savefig('/home/mic/wine/figs/dim_red_m_concat.png')
